  ...
  describe('Log', function() {
    ...
    describe('escaping', function() {
      return it('escapes a script tag', function() {
        var html;
        html = strip('<p><span id="0-0">&lt;script&gt;alert("hi!")&lt;/script&gt;</span></p>');
